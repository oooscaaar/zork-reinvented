...
World::World() {
	...
	Exit* hallToEmergencySpaceshipRoom = new Exit("North Door", "Obviously, this door is closed with a security key", DirectionType::NORTH, hall, emergencySpaceshipRoom, "You entered the room. There is huge spaceship\nready to TAKE OFF.\nYou should definetly try to TAKE OFF.\nHurry up, there's no much time left!", true);
	...
	Exit* hallToHubbleTelescopeRoom = new Exit("West Door", "F*ck, I'm not allowed to gaze at the stars.", DirectionType::WEST, hall, hubbleTelescopeRoom, "You've manged to access the telescope room.\nYou see a huge TELESCOPE in the middle of the chamber.\nYou are full of confidence, you can save the world!", true);
	...
	Item* idCard = new Item("id", "Even if you look like an alien on that photo,\nthis is your NFC ID card.", AsciiArt::id);
	Item* telescope = new Item("telescope", "The Hubble telescope is amazing.\nNow you know why it was several decades in the making.", AsciiArt::telescope);
	Item* laptop = new Item("laptop", "That is your computer. Maybe you should start the work day\nchecking your email inbox...", AsciiArt::laptop);
	...
	Item* key = new Item("key", "This key opens the door that leads to the\nEmergency Spaceship takeoff platform.", AsciiArt::key, ItemType::KEY);
	Item* spaceShip = new Item("spaceship", "This ship will take you really far from here.\nIt looks blazingly FAST!", AsciiArt::spaceShip);
