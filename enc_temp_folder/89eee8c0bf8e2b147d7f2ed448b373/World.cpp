...
World::World() {
	...
	Exit* hallToHubbleTelescopeRoom = new Exit("West Door", "F*ck, I'm not allowed to gaze at the stars.", DirectionType::WEST, hall, hubbleTelescopeRoom, "Finally, you mange to access the room. You see a huge TELESCOPE in the middle of the chamber. You are full of confidence, you can save the world", true);
